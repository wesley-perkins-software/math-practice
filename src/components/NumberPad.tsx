    ...
    <div className="w-full select-none mt-2">
      ...
      <div className="grid grid-cols-3 gap-2">
        <button
          ...
          className="h-16 rounded-2xl bg-[#F1F5F9] hover:bg-[#E2E8F0] active:bg-[#CBD5E1] text-[#64748B] text-2xl font-semibold transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center"
        >
