...
- **Created:** 2026-08-02
- **Last updated:** 2026-08-02 (Canonical Generated-Page Standard architecture added, defining the design for extending the leaf-page standard to the 24 generated Times Tables / Divide By pages)
...
- [ ] Implement the per-number fact-bank data modules described in `docs/seo/CANONICAL_GENERATED_PAGE_STANDARD.md` — **not started.**
- [ ] Roll the new standard out to the 24 generated Times Tables / Divide By pages — **not started**, blocked on the data-module implementation above.
...
**Generated-page architecture (new in this update):** `docs/seo/CANONICAL_GENERATED_PAGE_STANDARD.md` was added, defining the canonical section order, data-driven authoring model, and anti-thin-content rules for the 24 generated Times Tables / Divide By pages. This is architecture-only — it proposes operation-specific data modules (`src/data/generated-practice/timesTables.ts`, `.../divideBy.ts`), a "substantive educational differentiation" standard (a real relationship, common mistake, derived-fact strategy, worked example, or an honest "no shortcut" statement per number — not phrasing variance or numeral substitution), family-level grade guidance with narrow per-number overrides only where defensible, and a 5-phase rollout plan. No data modules, `.astro` pages, or layouts were created or modified as part of this update; implementation is tracked as separate future work.
...
| 13 | Canonical Generated-Page Standard — architecture for the 24 generated pages | Medium | ✅ Architecture done (this update); implementation not started | Unblocks item 12's deferred generated-page extension by defining the data-module design and anti-thin-content rule; see `docs/seo/CANONICAL_GENERATED_PAGE_STANDARD.md`. Implementing the data modules and rolling out to the 24 pages remains future work. |
