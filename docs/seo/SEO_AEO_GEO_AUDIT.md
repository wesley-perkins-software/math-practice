...
- **Created:** 2026-08-02
- **Last updated:** 2026-08-02 (Phase 1A complete: multiplication times-table fact bank authored in `src/data/generated-practice/`, per the Canonical Generated-Page Standard — data layer only, no generated page migrated yet)
...
- [ ] Migrate `[table].astro` / `.../index.astro` / `[divisor].astro` to read from the new data modules and roll the standard out to all 24 generated pages — **not started**, blocked on Phase 1B and a Phase 2 pilot per the standard's phased rollout plan.
